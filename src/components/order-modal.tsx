...
export function OrderModal({
  ...
  async function handleSubmit(event: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      setStatus('success');
      setMessage('Commande envoyée. Nous vous contacterons bientôt pour confirmer.');
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto bg-black/72 px-4 py-6 backdrop-blur-md">
      <div className="flex min-h-full items-start justify-center lg:items-center">
        <div className="grid w-full max-w-5xl overflow-hidden rounded-[2rem] border border-white/10 bg-[#090909] shadow-panel lg:max-h-[92vh] lg:grid-cols-[1.02fr_0.98fr]">
          <div className="relative hidden min-h-[620px] overflow-hidden border-r border-white/10 bg-gradient-to-br from-white/[0.08] to-transparent p-10 lg:block">
            ...
            <div className="relative z-10 flex h-full flex-col justify-between">
              <div>
                <p className="text-xs uppercase tracking-[0.3em] text-white/45">LMAJHOL / COMMANDE</p>
                <h2 className="mt-5 max-w-md text-4xl font-semibold leading-tight text-white">
                  Finalise la commande et laisse-nous préparer ton tee.
                </h2>
              </div>
          ...
          <div className="relative max-h-[88vh] overflow-y-auto p-6 sm:p-8 lg:max-h-[92vh] lg:p-10">
